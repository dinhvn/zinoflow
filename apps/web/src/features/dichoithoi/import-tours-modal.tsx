...
/**
 * Modal "Nhập từ Sheet" cho Tour — CHỈ Google Sheet (không chọn file/dán trực
 * tiếp). Giữ nguyên luồng xem trước (dry-run) → xác nhận gộp trùng tên → ghi
 * thật (tour-spec §5).
 */
export function ImportToursModal({
  open,
  onClose,
  onImported,
}: {
  ...
  return (
    <Modal open={open} onClose={handleClose} title="Nhập tour từ Google Sheet">
