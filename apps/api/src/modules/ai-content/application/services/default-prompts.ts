...
export const DEFAULT_PROMPTS: Readonly<Record<string, string>> = {
  ...
  "guide-diem-den-flagship.outline.vi": [
    ...
    `- sectionHeadings: 5-8 mục H2 phủ góc nhìn TỔNG QUAN cả vùng, không đi sâu 1 điểm con cụ thể:`,
    `  giới thiệu tổng quan & nét đặc trưng; nên đi mùa nào/thời điểm nào đẹp nhất;`,
    `  cách di chuyển tới đây (từ các thành phố lớn, 2 chiều đi và về); ăn gì đặc trưng của vùng.`,
    `- BẮT BUỘC có 1 heading riêng về "mùa"/"thời điểm" đẹp nhất để đi (chứa từ`,
    `  "mùa" hoặc "thời điểm") — đây là câu hỏi search intent hàng đầu với điểm đến lớn,`,
    `  KHÔNG được bỏ qua.`,
  ...
  "guide-diem-den-flagship.section.vi": [
    ...
    `- Nếu heading này là mục "mùa/thời điểm": nêu rõ mùa nào đẹp nhất, mùa nào nên tránh`,
    `  (mưa/lễ hội đông), gợi ý thời điểm cụ thể trong năm nếu dữ liệu cho phép.`,
